...
namespace SpatialPartitionPattern
{
    public class GameController : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            //make cow not sideways
             // Define a rotation of -90 on the X axis
            ...
            for (int i = 0; i < numberOfSoldiers; i++)
            {
                ...
                // Set the enemy's rotation to -90 on the X axis This is whack
                //newEnemy.transform.rotation = Quaternion.Euler(-90f, 0f, 0f);
